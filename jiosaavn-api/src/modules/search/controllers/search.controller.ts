  ...
  public initRoutes() {
              ...
              "application/json": {
                schema: z.object({
                  ...
                  data: SearchModel.openapi({
                    description:
                      "Search results including songs, albums, artists, and playlists",
                  }),
                }),
              },
            },
            ...
            content: {
              "application/json": {
                schema: z.object({
                  success: z.boolean().openapi({
                    description:
                      "Indicates whether the song search was successful",
                    type: "boolean",
                    example: true,
                  }),
    ...
    this.controller.openapi(
            ...
            content: {
              "application/json": {
                schema: z.object({
                  success: z.boolean().openapi({
                    description:
                      "Indicates whether the album search was successful",
                    type: "boolean",
                    example: true,
                  }),
      ...
      async (ctx) => {
        ...
        const result = await this.searchService.searchAlbums({
          query,
          page: page || 0,
          limit: limit || 10,
        });
    ...
    this.controller.openapi(
            ...
            content: {
              "application/json": {
                schema: z.object({
                  success: z.boolean().openapi({
                    description:
                      "Indicates whether the artist search was successful",
                    type: "boolean",
                    example: true,
                  }),
      ...
      async (ctx) => {
        ...
        const result = await this.searchService.searchArtists({
          query,
          page: page || 0,
          limit: limit || 10,
        });
    ...
    this.controller.openapi(
            ...
            content: {
              "application/json": {
                schema: z.object({
                  success: z.boolean().openapi({
                    description:
                      "Indicates whether the playlist search was successful",
                    type: "boolean",
                    example: true,
                  }),
      ...
      async (ctx) => {
        ...
        const result = await this.searchService.searchPlaylists({
          query,
          page: page || 0,
          limit: limit || 10,
        });
