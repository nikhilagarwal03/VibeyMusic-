...
const Sidebar = () => {
  ...
  return (
    <div className="hidden md:flex w-[244px] h-full flex-col px-4 py-5 border-r border-white/5 bg-black/25 backdrop-blur-xl">
      ...
      <nav className="flex flex-col gap-1 font-medium">
        {navItems.map((item) => (
          <button
            ...
            className={`flex items-center gap-3.5 px-3.5 py-3 rounded-lg motion-base ${
              activeView === item.id
      ...
      <div className="mt-auto pt-5 border-t border-white/5">
        <p className="type-caption text-gray-400 mb-3 px-2">Your Vibes</p>
